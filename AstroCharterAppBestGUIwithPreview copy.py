...
from PyQt5.QtWidgets import (
    ...
    QVBoxLayout, QHBoxLayout, QWidget, QMessageBox, QTabWidget, QFileDialog
)
    ...
    def get_person_data(self, entries):
        try:
            ...
            return {
                ...
                "hour": hour,
                "minute": minute,
                "lat": latitude,  # Corrected key
                "lng": longitude,  # Corrected key
                "tz_str": timezone,  # Corrected key
            }
